...
- **版面 Mockup**：1080×1080 / 1080×1350 / 1080×1440 / 1080×1920 / 16:9 / A4 或自訂；
  ...
  光場預設「合併」：同一效果圖層在整個版面只做一張遮罩（symbol + use），一盞燈的反光帶連續掃過所有卡，交疊處以遮擋遮罩處理；亦可切「各卡獨立」。光源可拖曳設定，並可調強度、X／Y／Z、大小；背景反光可關（消光桌面）；卡片離地高度影響投影距離與軟硬；每張卡片各自反光與投影；整體旋轉；**卡片版本混搭**：把不同效果組合存成版本 A／B／C，版面上的卡片依序輪流或隨機套用
